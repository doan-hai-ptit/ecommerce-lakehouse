...
# ClickHouse connection details (inside docker network)
...
def main():
    ...
    gold_tables = list(PRIMARY_KEYS.keys())
    ...
    for table_name in gold_tables:
        ...
        s3_path = f"s3://gold-lakehouse/{table_name}"
        ...
        try:
            ...
            # Build column list
            columns_ddl = []
            pk_list = PRIMARY_KEYS.get(table_name, [])
