...
def test_minio_connection():
    ...
    MINIO_CONFIG = {
        ...
        'aws_access_key_id': 'o8G5wmNfm5rObtrDtQEc',  # Thay bằng Access Key mới tạo
        'aws_secret_access_key': '1mXPbGQDnpOPwLMOXVdraR3XuhMLX7OVjGdWXspj', # Thay bằng Secret Key mới tạo
